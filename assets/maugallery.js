      ...
      prevImage() {
        ...
        "all" === e
          ? t(".item-column").each(function () {
              t(this).children("img").length &&
                l.push(t(this).children("img").get(0));
            })
          : t(".item-column").each(function () {
        ...
        let i =
          l[
            (l.findIndex((e) => t(e).attr("src") === t(a).attr("src")) -
              1 +
              l.length) %
              l.length
          ];
        t(".lightboxImage").attr("src", t(i).attr("src"));
      },
      nextImage() {
        let a = null;
        t("img.gallery-item").each(function () {
        ...
        let i =
          l[
            (l.findIndex((e) => t(e).attr("src") === t(a).attr("src")) + 1) %
              l.length
          ];
        t(".lightboxImage").attr("src", t(i).attr("src"));
      },
